...
public partial class Klinicos_BEntities : DbContext
{
    ...
    public virtual ObjectResult<SP_OBTENER_SEMANAL_EVOLUCIONES1_Result> SP_OBTENER_SEMANAL_EVOLUCIONES1(string mes, string anio, Nullable<int> idSector, Nullable<int> idEstablecimiento)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_OBTENER_SEMANAL_EVOLUCIONES1_Result>("SP_OBTENER_SEMANAL_EVOLUCIONES1", mesParameter, anioParameter, idSectorParameter, idEstablecimientoParameter);
    }
